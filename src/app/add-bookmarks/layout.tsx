  ...
  '@graph': [
    {
      ...
      description: 'Add clickable bookmarks that appear in the PDF reader sidebar. Create a table of contents for long documents. 100% free, no upload, no watermark.',
