  ...
  '@graph': [
    {
      ...
      url: 'https://doclair.com/redact-pdf',
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Redact PDF', item: 'https://doclair.com/redact-pdf' },
  ],
}
...
export default function RedactPDFPage() {
  ...
  return (
    <ToolPageLayout toolName="Redact PDF" toolSlug="redact-pdf" sidebar={sidebar}>
      {/* JSON-LD */}
