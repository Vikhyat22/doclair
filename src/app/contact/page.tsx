        ...
        <div className="section-inner" style={{ maxWidth: '720px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            <div style={{ background: 'white', border: '1px solid var(--border)', borderRadius: '14px', padding: '28px' }}>
              ...
              <p style={{ fontSize: '15px', color: 'var(--ink)', opacity: 0.65, lineHeight: 1.7, marginBottom: '12px' }}>For bug reports and feature requests, open an issue:</p>
              <span style={{ fontFamily: 'var(--font-dm-mono), DM Mono, monospace', fontSize: '14px', color: 'var(--amber)' }}>github.com/doclair/doclair</span>
            </div>
